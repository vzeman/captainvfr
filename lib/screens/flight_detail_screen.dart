...
class _FlightDetailScreenState extends State<FlightDetailScreen> {
  ...
  void _shareFlightData() {
    ...
    sb.writeln('Duration: ${_formatDuration(flight.duration)}');
    ...
    sb.writeln('Recording Started: ${_formatZuluTime(flight.recordingStartedZulu)}');
    if (flight.recordingStoppedZulu != null) {
      sb.writeln('Recording Stopped: ${_formatZuluTime(flight.recordingStoppedZulu!)}');
    }

    // Share the flight data
    Share.share(sb.toString(), subject: 'Flight Details');
  }
