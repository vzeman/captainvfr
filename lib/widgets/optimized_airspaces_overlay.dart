...
class OptimizedAirspacesOverlay extends StatefulWidget {
  ...
  @override
  State<OptimizedAirspacesOverlay> createState() =>
      _OptimizedAirspacesOverlayState();
}
...
class _OptimizedAirspacesOverlayState extends State<OptimizedAirspacesOverlay> {
  ...
  Widget build(BuildContext context) {
    ...
    final paddedBounds = LatLngBounds(
      LatLng(bounds.southWest.latitude - 0.5, bounds.southWest.longitude - 0.5),
      LatLng(bounds.northEast.latitude + 0.5, bounds.northEast.longitude + 0.5),
    );
    ...
    for (final airspace in widget.airspaces) {
      ...
      bool isVisible =
          !(airspaceBounds.northEast.latitude <
                  paddedBounds.southWest.latitude ||
              airspaceBounds.southWest.latitude >
                  paddedBounds.northEast.latitude ||
              airspaceBounds.northEast.longitude <
                  paddedBounds.southWest.longitude ||
              airspaceBounds.southWest.longitude >
                  paddedBounds.northEast.longitude);
