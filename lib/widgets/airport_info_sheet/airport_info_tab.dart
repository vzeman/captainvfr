    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          InfoRow(label: 'Type', value: airport.type.replaceAll('_', ' ').toUpperCase()),
          InfoRow(label: 'Elevation', value: '${airport.elevation} ft'),
          InfoRow(
            label: 'Coordinates',
            value: '${airport.position.latitude.toStringAsFixed(6)}, ${airport.position.longitude.toStringAsFixed(6)}',
          ),
          ...
          if (airport.website != null && airport.website!.isNotEmpty)
            ActionButton(
              icon: Icons.language,
              label: 'Visit Website',
              onPressed: () => UrlLauncherUtils.launch(context, airport.website!),
            ),
          ...
          if (airport.phone != null && airport.phone!.isNotEmpty)
            ActionButton(
              ...
              onPressed: () => UrlLauncherUtils.launch(context, 'tel:${airport.phone}'),
            ),
